...
export class DropDown extends React.Component<DropDownProps, DropDownState> {
    ...
    public render() {
        ...
        return (
            <div className='work-dropdown' ref={(el) => this.el = el}>
                <div qe-id={this.props.qeId} className='work-dropdown__anchor' onClick={(event) => { this.open(); event.stopPropagation(); }}>
                    <this.props.anchor />
                </div>
                {ReactDOM.createPortal((
                    <div className={classNames('work-dropdown__content', { 'opened': this.state.opened, 'is-menu': this.props.isMenu })}
    ...
    private refreshState() {
        const anchor = this.el.querySelector('.work-dropdown__anchor') as HTMLElement;
