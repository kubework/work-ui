...
class TableExample extends React.Component<{}, { selectedIndex: number }> {
    ...
    public render() {
        ...
        return (
            <div className='work-table-list work-table-list--clickable'>
                <div className='work-table-list__head'>
                    <div className='row'>
                ...
                {items.map((item, i) => (
                    <div className={classNames('work-table-list__row', { selected: i === this.state.selectedIndex })} key={i} onClick={() => this.setState({ selectedIndex: i })}>
                        <div className='row'>
