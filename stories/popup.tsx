...
storiesOf('Popup', module)
    .add('confirmation', () => (
        <App>
            {(apis) => (
                <button className='work-button work-button--base' onClick={async () => {
        ...
        <App>
            {(apis) => (
                <button className='work-button work-button--base' onClick={() => {
            ...
            {(apis) => (
                <button className='work-button work-button--base' onClick={() => {
                    apis.popup.prompt('Username: test Password: test', (api) => (
                        ...
                        { name: 'work-icon-warning', color: 'failed' },
                        'red');
                }}>Click me</button>
            )}
        </App>
            ...
            {(apis) => (
                <button className='work-button work-button--base' onClick={() => {
                    apis.popup.prompt('Username: test Password: test', (api) => (
                        ...
                        { name: 'work-icon-workflow', color: 'warning' },
                        'yellow');
                }}>Click me</button>
            )}
        </App>
            ...
            {(apis) => (
                <button className='work-button work-button--base' onClick={() => {
                    apis.popup.prompt('Username: test Password: test', (api) => (
                        ...
                        { name: 'work-icon-clock', color: 'success' },
                    );
                }}>Click me</button>
            )}
        </App>
